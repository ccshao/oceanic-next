...
" {{{ call s::hi(group, fg, bg, gui, guisp)
  ...
  call s:hi('WildMenu',                   s:base06,  s:blue,   '',          '')
  ...
  call s:hi('PMenuSel',                   s:base06,  s:blue,   '',          '')
  call s:hi('PmenuSbar',                  '',       s:base02, '',          '')
  call s:hi('PmenuThumb',                 '',       s:base06, '',          '')
  ...
  call s:hi('TSPunctDelimiter',           s:base06,  '',       '',          '')
  call s:hi('TSParameter',                s:base06,  '',       '',          '')
  ...
  call s:hi('TSConstructor',              s:base06,  '','','')
  call s:hi('TSVariable',                 s:base06,  '','','')
  call s:hi('TSOperator',                 s:base06,  '','','')
  call s:hi('TSTag',                      s:base06,  '',       '',          '')
  ...
  call s:hi('htmlTagName',                s:base06,  '',       '',          '')
